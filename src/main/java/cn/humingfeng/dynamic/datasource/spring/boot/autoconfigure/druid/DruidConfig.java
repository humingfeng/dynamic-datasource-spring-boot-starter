...
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.ASYNC_INIT;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.CLEAR_FILTERS_ENABLE;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.FAIL_FAST;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.FILTERS;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.INITIAL_SIZE;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.INIT_CONNECTION_SQLS;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.INIT_GLOBAL_VARIANTS;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.INIT_VARIANTS;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.KEEP_ALIVE;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.KILL_WHEN_SOCKET_READ_TIMEOUT;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.MAX_ACTIVE;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.MAX_EVICTABLE_IDLE_TIME_MILLIS;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.MAX_POOL_PREPARED_STATEMENT_PER_CONNECTION_SIZE;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.MAX_WAIT;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.MAX_WAIT_THREAD_COUNT;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.MIN_EVICTABLE_IDLE_TIME_MILLIS;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.MIN_IDLE;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.NOT_FULL_TIMEOUT_RETRY_COUNT;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.PHY_TIMEOUT_MILLIS;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.POOL_PREPARED_STATEMENTS;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.RESET_STAT_ENABLE;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.STAT_LOG_SLOW_SQL;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.STAT_MERGE_SQL;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.STAT_SLOW_SQL_MILLIS;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.STAT_SQL_MAX_SIZE;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.TEST_ON_BORROW;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.TEST_WHILE_IDLE;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.TIME_BETWEEN_EVICTION_RUNS_MILLIS;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.TIME_BETWEEN_LOG_STATS_MILLIS;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.USE_GLOBAL_DATA_SOURCE_STAT;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.USE_UNFAIR_LOCK;
import static cn.humingfeng.dynamic.datasource.spring.boot.autoconfigure.druid.DruidConsts.VALIDATION_QUERY;
